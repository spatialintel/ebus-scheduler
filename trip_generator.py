...
def _generate_revenue_trips(config, headway_df, travel_time_df):
    ...
    def _slot_interval(dep):
        """Effective slot interval: max of user headway and natural fleet gap."""
        return max(_get_headway_at(dep, headway_df), natural_gap)
    ...
    # First UP starts after a bus completes first DN + break.
